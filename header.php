<header>
  <div class="header-wrapper">
    <div class="header-logo">
      <a href="index.php" style="color:white;">Switchインディーズライフ</a>
    </div>
    <div id="top-nav">
      <ul>
        ...
        ?>
          <li><a href="mypage.php?u_id=<?php echo htmlspecialchars($_SESSION['user_id']) ?>"><i class="fas fa-gamepad my-gray"></i>マイページ</a></li>
