    ...
    if(empty($err_msg)){
      ...
      try{
        ...
        if($stmt){
          ...
          debug('セッション変数の中身:'.print_r($_SESSION['user_id'],true));
    ...
    <section id="form-container">
      ...
      <form id="form-main" action="" method="post" enctype="multipart/form-data">
        ...
        <label class="<?php if(!empty($err_msg['username'])) echo 'err'; ?>">
          ユーザー名<br>
          <input type="text" name="username" class="textbox" value="<?php if(!empty($_POST['username'])) echo $_POST['username']; ?>">
        </label>
        <div class="area-msg">
        ...
        <label class="<?php if(!empty($err_msg['password'])) echo 'err'; ?>">
          パスワード<span class="area-msg">※英数字6文字以上</span><br>
